...
class Registrant extends Model
{
    ...
    public function get()
    {
        if (in_array('get', $this->methods)) {
            $this->response = $this->client->get($this->type."/{$this->relationshipID}/registrants".$this->getQueryString());
    ...
    public function all()
    {
        if ($this->relationshipID != '') {
            return $this->collect($this->get($this->type."/{$this->relationshipID}/registrants"));
        } else {
